  ...
  <div  class="individual">
    ...
    <div  class="individual_right">
      ...
      <ul  class="individual_right_ul_1">
        ...
        <li  class="individual_right_ul_1_img"> <img  src="<?php echo strstr($username['pic'],'../r'); ?>"> <img  src="<?php echo strstr($username['picm'],'../r'); ?>"> <img  src="<?php echo strstr($username['pics'],'../r'); ?>"> </li>
        <li>
          <h3>设置我的新头像</h3>
        </li>
        ...
        <li>
          <input  type="image"  src="resource/images/40.png">
        </li>
      </ul>
    </div>
  </div>
