...
<form action="./index.php?m=user&a=mod&id=<?php echo $id ?>" method="post" enctype="multipart/form-data" class="navbar-form navbar-left" >
	...
	<tr><td>电话：</td><td><input type="text" name="telphone" value="<?php echo $user['telphone'] ?>"   /></td></tr>
	...
	<tr><td colspan=2>                  <input type="submit" value="确认修改" class="btn btn-default" /></td></tr>
</form>
</table>
</div>